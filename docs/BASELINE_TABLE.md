...
|---|---|---|---|---|---|---|
| LSTM       | 0.839±0.016 *(n=3)* | 0.403±0.065 *(n=3)* | 0.826±0.050 *(n=3)* | 0.427±0.067 *(n=3)* | 0.823±0.075 *(n=3, w/ ext s123)* | 0.064±0.007 *(n=3, w/ ext s123)* |
| CNN-LSTM   | 0.824±0.014 *(n=3)* | 0.365±0.053 *(n=3)* | 0.690±0.026 *(n=3)* | 0.242±0.020 *(n=3)* | 0.798±0.110 *(n=3)* | 0.049±0.032 *(n=3)* |
| BIOT       | 0.811±0.006 *(n=3)* | 0.301±0.013 *(n=3)* | 0.717±0.060 *(n=3)* | 0.292±0.036 *(n=3)* | 0.903±0.018 *(n=3, w/ ext s123)* | 0.054±0.094 *(n=3, w/ ext s123)* |
| LaBraM     | 0.863±0.010 *(n=3)* | 0.398±0.034 *(n=3)* | 0.865±0.007 *(n=3)* | 0.466±0.016 *(n=3)* | 0.787±0.010 *(n=3)* | 0.054±0.022 *(n=3)* |
| EEGPT      | 0.884±0.004 *(n=3)* | 0.438±0.010 *(n=3)* | 0.784±0.009 *(n=3)* | 0.343±0.007 *(n=3)* | 0.911±0.016 *(n=3)* | 0.266±0.025 *(n=3)* |
| EvolveGCN  | 0.812±0.006 *(n=3)* | 0.356±0.018 *(n=3)* | 0.752±0.010 *(n=3)* | 0.333±0.025 *(n=3)* | 0.810±0.015 *(n=3)* | 0.062±0.013 *(n=3)* |
| DCRNN      | 0.896±0.003 *(n=3)* | 0.513±0.006 *(n=3)* | 0.895±0.011 *(n=3)* | 0.574±0.019 *(n=3)* | 0.877±0.006 *(n=3, w/ ext s123)* | 0.125±0.018 *(n=3, w/ ext s123)* |
| GRAPHS4MER | 0.884±0.002 *(n=3)* | 0.461±0.001 *(n=3)* | 0.856±0.017 *(n=3)* | 0.474±0.046 *(n=3)* | 0.899±0.015 *(n=3)* | 0.185±0.046 *(n=3)* |
| GRU-GCN    | 0.894±0.005 *(n=3)* | 0.527±0.059 *(n=3)* | 0.907±0.001 *(n=3)* | 0.640±0.012 *(n=3)* | 0.907±0.005 *(n=3)* | 0.171±0.025 *(n=3)* |
| EvoBrain | — | — | — | — | — | — |
...
### Running
- `8704005` upd_basetbl (0:22)
- `8709615_0` sw_other (1:50)
- `8709615_1` sw_other (1:50)
- `8695162_1` sw60_p3b (2:42:57)
- `8695162_2` sw60_p3b (2:42:57)
- `8695162_3` sw60_p3b (2:42:57)
- `8695162_4` sw60_p3b (2:42:57)

### Pending
- `8673693` chb_test (0:00)
- `8673681` chb_test (0:00)
- `8673680` chb_test (0:00)
- `8673679` chb_test (0:00)
- `8673672` chb_test (0:00)
